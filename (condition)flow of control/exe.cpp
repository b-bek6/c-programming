...
validity_enabler got rised after checking for array[7][7]
 color=col1;
 sp_color=col2;
 return(0);
 }
...
printf(" Same thing to user2 also, he got to play with Green boxes.");
...
USER2 CONTROL KEYS:");
printf("*********************");
printf(" D = left movement R = up-ward movement  G = right movement V = down-ward movement F = Enter key ");
getch();
clrscr();
}
int preamble()
{ int options;
 ...
 printf("******************");
 printf(" 1. Instructions 2. Single player game(player2=computer)");
...
void welcome_note()
{
printf(" Hi, this is Manikanta.c.v, completed B.E (TCE) at Dr.Ambedkar Institute Of Tehnology,Bangalore. ");
printf("if you have any comments regarding this game means please let me know through cvm.mani@hotmail.com -THANK YOU");
getch();
clrscr();
}
main()
